...
const StatCard = ({ item }) => {
  ...
  return (
    ...
    <div className="bg-white p-8 lg:p-9 rounded-xl shadow-sm flex items-center gap-6 lg:gap-7 min-h-[160px] lg:min-h-[180px] justify-center">
...
const CounterComponent = () => {
  return (
    <section className="py-12 lg:py-10 bg-[#f8f9fa]">
      {/* Kept at max-w-7xl but added a bit more side padding for desktop */}
      <div className="max-w-[1592px] mx-auto px-6 lg:px-10">
