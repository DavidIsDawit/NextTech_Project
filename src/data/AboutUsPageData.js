export const aboutData = {
  subtitle: "ABOUT US",
  title: "What we offer through our company",
  description: "We are a team of professionals dedicated to delivering the best services to our clients. Our experience and passion drive us to succeed in everything we do.",
  features: [
    {
      id: 1,
      title: "Mission",
      text: "To exceed the expectation of the customers & provide them with the best engineering services & the most reliable support system.",
      icon: "/AboutUsPageImages/lessTargetIcon.png" 
    },
    {
      id: 2,
      title: "Vission",
...
export const workflowData = {
  ...
  title: "We're helping you turn your idea into a great product",
  steps: [
    {
      id: "01",
